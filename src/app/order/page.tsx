...
import { UploadCloud, Palette, Ruler, Pencil } from "lucide-react";
        ...
        <div className="w-full max-w-2xl mb-12">
          <div className="flex items-center justify-between">
            {steps.slice(0, 4).map((s, idx) => (
              <div key={idx} className="flex items-center text-xs text-center flex-col">
                <div
            ...
            >
              ...
              {step === 2 && (
                <div className="space-y-6">
                  ...
                  <RadioGroup defaultValue="canvas" className="space-y-4">
                    {[
              ...
              {step === 4 && (
                <div className="space-y-6">
                  <h2 className="font-headline text-3xl text-foreground">5. Checkout</h2>
                  <div className="grid grid-cols-1 gap-4">
                    <Input placeholder="Full Name" />
                    <Input type="email" placeholder="Email Address" />
                    <div className="p-3 border rounded-lg bg-input/40">
                       <p className="text-sm text-muted-foreground">Card details (mock UI)</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              {step < 5 && (
                <div className="flex justify-between items-center pt-8">
                  ...
                  <Button onClick={next} className="rounded-full bg-primary text-primary-foreground px-10 py-3 text-lg shadow-md hover:shadow-lg hover:bg-primary/90 transition-all">
                    {step === 4 ? "Complete My Commission" : "Next"}
                  </Button>
                </div>
              )}
            </motion.div>

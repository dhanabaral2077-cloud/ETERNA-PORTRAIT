...
export async function POST(req: Request) {
    try {
        ...
        const customer = { id: `cus_${crypto.randomUUID()}`, email, name }; // Mock customer
        ...
        const order = { id: `ord_${crypto.randomUUID()}` }; // Mock order
        ...
        // });
        console.log("Sent OrderConfirmation email to:", email);

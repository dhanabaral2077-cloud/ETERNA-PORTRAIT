      ...
      <div className="container max-w-4xl mx-auto px-4 md:px-6">
        <div className="bg-background rounded-lg shadow-xl p-8 md:p-12 animate-fade-in-up">
          <div className="text-center mb-8">
            <h2 className="text-4xl md:text-5xl font-bold font-headline text-foreground mb-4 animate-fade-in-up">Ready to Immortalize Your Pet?</h2>
            <p className="max-w-xl mx-auto text-lg text-muted-foreground animate-fade-in-up animation-delay-300">
              Let's create a beautiful, lasting memory of your furry, feathery, or scaly friend.
            </p>
          </div>

          <div className="text-center pt-4 animate-fade-in-up animation-delay-600">
            <Button 
              asChild
              size="lg" 
